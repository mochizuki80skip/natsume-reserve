...
| `/admin/day/<日付>` | 店舗 | Excel 風の予約表（ベッド 8 列）。シフト（施術者 6・受付 4）、午前/午後の人数、メモ |
...
- **シフト**：予約表上部の「本日のシフト」に入力した施術者の人数が、患者様に見える空き枠数になる。
  未入力の日は店舗設定の「既定の施術者数」を使う。管理側は施術者数に関係なく 8 列すべてに入力できる。
